<section class="centered register-form">
    ...
    <h1 class="content-zone__header"><?= $createMemberL ?></h1>
    <?php
    ...
    <form action="<?= \Lib\HelperService::currentLang() ?>/admin/members/store" method="post" class="form">
        ...
        <br>
        <p>
            <button type="submit" class="subscribtion-form__button" id="addMemberSubmitBtn"><?= $addMemberL ?></button>
        </p>
